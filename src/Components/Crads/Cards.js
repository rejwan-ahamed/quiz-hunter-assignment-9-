      ...
      <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
        <a>
          <img
            ...
            src="https://images.unsplash.com/photo-1659535958543-efbf6ac67f29?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
            alt=""
          />
        </a>
        <div className="p-5">
